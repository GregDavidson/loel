...
Welcome, Dear Viewer: I'm looking forward to sharing with you the gist
...
I've been working on a new educational system which puts Learners
First. and I've been running into Paradigms in our society which limit
what's possible.

In this video I'd like to reveal those Paradigms and related Contexts
so that we have the awareness to create outside of traditional limits.
...
Earlier we were talking about them and we got some confusions about
Paradigms and Contexts, so we looked them up.  Lynn, would you read
the first two definitions of what we found for Context in the
...
You get this notice that a Context is something additional, that is
surrounding something, giving it meaning.
...
There we go: Properly considered, or sometimes improperly considered
or not considered at all!

Ideally contexts would be explicit and consciously noticed. But they
are often implicit and not consciously noticed.  In that case the
meanings which they determine simply occurs as "the truth" or just
"they way things are".

Lynn, would you read what the American Heritage dictionary says about
Paradigm:
...
There we go. Paradigms are the Bigger, Broader Contexts at the level
of our community or society. We generally don't consciously notice
them, even as they determine our assumptions, understanding, values
and what appears to be reality.

Before we can think freely or act freely, we have to get clear about
any existing Contexts which are influencing us. Any contexts which
we're not aware of will tend to do our thinking for us!
